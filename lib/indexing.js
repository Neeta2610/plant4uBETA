...
const indexProducts = (app) => {
    ...
    return new Promise((resolve, reject) => {
        app.db.products.find({productStock: {$gt: 0},productPublished: true}).toArray((err, productsList) => {
            if(err){
            ...
            const productsIndex = lunr(function(){
                this.field('productTitle', { boost: 100 });
                this.field('productTags', { boost: 40 });
                this.field('productminiDescription');
                ...
                productsList.forEach((product) => {
                    const doc = {
                        ...
                        productminiDescription: product.productminiDescription,
                        id: product._id
                    };
                    lunrIndex.add(doc);
                });
